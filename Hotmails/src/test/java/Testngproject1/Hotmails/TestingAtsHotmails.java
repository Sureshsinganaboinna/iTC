...
public class TestingAtsHotmails {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int j=0; j<10; j++)
		{
		 ...
		 //WebDriverManager.chromedriver().setup();
	      ...
	      String[] mail ={"leeladeveloper123@hotmail.com","chinna_palla@hotmail.com","varaprasad_neerukattu123@hotmail.com"
...
//     driver.findElement(By.xpath("//button[@aria-label = 'Send']")).click();
        driver.findElement(By.xpath("//span[@title='Suresh@experthiring.com']")).click();
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//*[@id=\"AQAAAAAAAQABAAAA9pgyswAAAAA=\"]/div/div/div[2]/div[2]/div[1]/div/span")).click();
        Thread.sleep(1000);
...
//     driver.findElement(By.xpath("//button[@aria-label = 'Send']")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"AQAAAAAAAQABAAAA9pgysgAAAAA=\"]/div/div/div[2]/div[2]/div[1]/div/span")).click();
        Thread.sleep(1000);
